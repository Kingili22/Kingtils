...
import net.minecraft.util.EnumChatFormatting;
    ...
    public class SetShiftYPosition extends CommandBase implements ICommand {
        @Override
        public String getCommandName() {
            return "SetShiftYPosition";
        }
